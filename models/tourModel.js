...
const tourSchema = new mongoose.Schema(
  {
    name: {
      ...
      //validate: [validator.isAlpha, 'Tour names must contain only letters'],
    },
    slug: String,
    duration: {
      type: Number,
    ...
    ratingsAverage: {
      ...
      max: [5, 'a rating maximum can be 5.0'],
    ...
    priceDiscount: {
      type: Number,
      validate: {
        //will not work for update only post
...
// tourSchema.virtual('nerd').get(function () {
...
//REGEX MEANS ALL STRINGS THAT BEGIN WITH FIND
tourSchema.pre(/^find/, function (next) {
