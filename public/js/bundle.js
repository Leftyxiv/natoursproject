...
var signUp = document.getElementById('signup-form'); // if (mapBox) {
...
if ((!parent || !parent.isParcelRequire) && typeof WebSocket !== 'undefined') {
  ...
  var ws = new WebSocket(protocol + '://' + hostname + ':' + "47811" + '/');
