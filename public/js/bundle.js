    ...
    return regeneratorRuntime.wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            _context.prev = 0;
            url = type === 'password' ? 'http://127.0.0.1:8000/api/v1/users/updateMyPassword' : 'http://127.0.0.1:8000/api/v1/users/updateMe'; //const method = type === 'password' ? 'POST' : 'PATCH',
...
var stripe = Stripe('pk_test_51ICUbJCmKh2QkhLrblIXLN8WyXOMcG8snpqJGvKAJ6I23fpIOUeQNUMBTr0dCijksuQYKTEhssdRfoYDA4tIxain00UHDreOsZ');
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            _context.prev = 0;
            _context.next = 3;
            return (0, _axios.default)("http://127.0.0.1/api/v1/bookings/checkout-session/".concat(tourId));
...
var displayMap = function displayMap(locations) {
  mapboxgl.accessToken = 'pk.eyJ1IjoibGVmdHl4aXYiLCJhIjoiY2tqdWU2M2djNzVhMTJxcDk5bWloZmJrdyJ9.7hQWRXosGdjoDldj-H6pgA';
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          ...
          case 3:
            ...
            if (res.data.status === 'success') {
              (0, _alerts.showAlert)('success', "Successfully registered new account, ".concat(name, "!"));
            }
